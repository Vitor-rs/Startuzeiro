...
Executar com uv:
    uv run scripts/utilitarios/yt_transcript.py --video "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
    uv run scripts/utilitarios/yt_transcript.py --search "automacao n8n" --limit 5
"""
...
def get_video_info(video_url: str):
    """Verifica idiomas disponíveis gratuitamente (0 créditos)."""
...
def search_youtube(query: str, search_type: str = "video", sort: str = "relevance"):
    """Pesquisa vídeos ou canais no YouTube (1 crédito)."""
