...
| :--- | :--- | :--- |
| **31 Skills (`firecrawl*`, `transcriptapi`, `context7*`)** | `.agents/skills/` (no repositório) | ✅ 100% versionado no Git |
| **Regras do Agente (`AGENTS.md`, rules)** | `.agents/rules/` e raiz | ✅ 100% versionado no Git (caminhos dinâmicos) |
| **Catálogo de 57 Ferramentas** | `ferramentas/catalogo.yaml` e `knowledge/` | ✅ 100% versionado no Git |
